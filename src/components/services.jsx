        ...
        <Grid>
            <div className="">
              <div className="text-center">
                <h1 className="font-['Caveat'] text-primary text-4xl text-center font-extrabold tracking-widest">Educação infantil</h1>
              ...
              <div className="lg:flex lg:gap-8 lg:mt-8 lg:justify-center ">
                ...
                <div className="mt-6 mx-3 border-dashed border-4 border-primary p-4 drop-shadow-xl rounded-3xl flex flex-col items-center justify-center md:mx-44 lg:mx-0">
                  <div className="flex items-center leading-6">
                    <h6 className="font-['Bungee'] tracking-widest text-primary text-xl font-bold ml-2 text-center lg:text-xl">Desenvolvimento<br /> integral</h6>
                  </div>
                </div>
          ...
          <Grid>
            ...
            <div className="mt-16 flex flex-col gap-8 sm:flex-row sm:justify-center sm:gap-12">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-4 text-white sm:max-w-[200px]">Maior flexibilidade de pensamento</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <img className="size-24" src={Solutions} alt="" />
                <p className="mt-4 text-white sm:max-w-[200px]">Abertura a diferentes soluções frente aos problemas vividos</p>
              </div>

              <div className="flex flex-col items-center text-center">
                <img className="size-24" src={Insight} alt="" />
                <p className="mt-4 text-white sm:max-w-[200px]">Agilidade de raciocínio</p>
              </div>
            </div>
          </Grid>
