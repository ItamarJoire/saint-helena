    ...
    <div className="bg-primary">
      <Grid>
        <div className="pt-20 pb-40 lg:flex lg:px-16">
          <div>
            <h2 className="font-['Bungee'] font-bold text-white text-5xl capitalize leading-[64px] max-w-[400px] mt-16 md:max-w-[500px] md:text-4xl md:leading-[52px]">O seu lar com beleza e autenticidade</h2>
