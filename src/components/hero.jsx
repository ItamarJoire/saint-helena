      ...
      <Grid>
        <div className="pt-24 pb-40 lg:flex lg:px-16">
          <div>
            ...
            <h4 className="mt-3 font-medium text-white text-lg leading-8">Somos apaixonados por transformar rochas naturais em obras-primas esculturais que elevam a decoração da sua casa a um patamar único.</h4>
